...
function createItem(collection, newItem) {
  ...
  function createCategory(newCategory) {
    createItem("taskCategory", newCategory);
    render();
  }
  
  // Function to read all Categorys
  function readAllCategories() {
    return readAllItems("taskCategory");
  }
  ...
  function updateCategoryProperty(categoryIndex, event) {
    ...
    updateItemProperty("taskCategory", categoryIndex, 'name', value);
    render();
  }
  
  // Function to delete a Category
  function deleteCategory(categoryIndex) {
    deleteItem("taskCategory", categoryIndex);
    render();
  }
